...
export default function AboutUsPage() {
  return (
    <>
      ...
      {/* ── WHO WE ARE ── */}
      <section className="relative overflow-hidden bg-linear-to-bl from-[#084E75]/8 via-white to-[#8D8C8F]/16 py-20 md:py-24">
        ...
        <div className="relative mx-auto max-w-7xl px-6">
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 lg:grid-rows-2 lg:h-[560px] [&>*]:min-w-0">
            ...
            >
              <div className="relative overflow-hidden rounded-3xl border border-[#084E75]/15 bg-linear-to-br from-[#8D8C8F]/12 via-[#EEF6FB] to-[#084E75]/25 p-7 h-full flex flex-col justify-center md:p-8">
                ...
                <h2 className="font-serif relative text-2xl font-semibold leading-snug text-[#084E75] md:text-3xl lg:text-4xl">
            ...
            >
              <div className="relative overflow-hidden rounded-3xl border border-[#084E75]/10 bg-linear-to-r from-[#084E75]/8 to-[#8D8C8F]/10 h-full flex items-center">
                <div className="pointer-events-none absolute left-0 top-0 h-full w-1 rounded-l-3xl bg-linear-to-b from-[#084E75] to-[#8D8C8F]" />
                ...
                <div className="px-7 py-7 flex-1 md:px-9 md:py-8">
                  ...
                  <Link
                    href="/contact"
                    className="mt-5 shrink-0 group inline-flex items-center justify-between rounded-full bg-[#084E75] hover:bg-[#0a5d8a] pl-5 pr-2 py-2 text-sm font-semibold text-white shadow-md shadow-black/15 transition-all hover:-translate-y-0.5 hover:shadow-lg w-36"
                  >
                    Get Started
          ...
          <div className="flex flex-col items-stretch gap-5 md:flex-row md:gap-6">
            {aboutPillars.map((pillar, i) => (
              ...
              >
                ...
                <div className="pointer-events-none absolute left-1/2 top-4 size-32 -translate-x-1/2 rounded-full bg-[#D9B872]/12 blur-2xl transition-all duration-300 group-hover:bg-[#D9B872]/20" />

                {/* Icon — plain symbol, no container */}
                <pillar.icon
                  className="relative mb-5 size-14 shrink-0 text-[#D9B872] drop-shadow-[0_4px_14px_rgba(204,102,105,0.45)] md:size-16"
                  stroke={1.4}
                />
                ...
                <div className="relative my-3 h-px w-10 bg-[#D9B872] shadow-[0_0_10px_rgba(204,102,105,0.7)]" />
      ...
      {/* ── CORE BELIEFS ── */}
      <section className="relative overflow-hidden bg-linear-to-br from-[#084E75]/10 via-white to-[#D9B872]/10 py-20 md:py-28">
        {/* Ambient blobs + dot grids */}
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute -right-24 -top-24 size-96 rounded-full bg-[#8D8C8F]/5 blur-3xl" />
          ...
          <svg className="absolute bottom-8 left-8 opacity-[0.04]" width="100" height="100" viewBox="0 0 100 100">
            {[0,1,2,3,4].flatMap(row => [0,1,2,3,4].map(col => (
              <circle key={`${row}-${col}`} cx={col*20+10} cy={row*20+10} r="1.5" fill="#8D8C8F" />
            )))}
          </svg>
        </div>
        ...
        <div className="relative mx-auto max-w-7xl px-6">
          ...
          <motion.div
            ...
            className="mb-16 max-w-2xl md:mb-20"
          >
            <span className="mb-3 flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.25em] text-[#8D8C8F]">
              <span className="size-2 rounded-full bg-[#8D8C8F]" />
              What Drives Us
            </span>
            <h4 className="mt-3 text-3xl font-semibold text-[#084E75] md:text-4xl">
              Our Core <span className="bg-linear-to-r from-[#D9B872] to-[#96701F] bg-clip-text text-transparent">Beliefs</span>
            </h4>
          </motion.div>
          ...
          >
            {coreBeliefs.map((belief, i) => (
              ...
              >
                ...
                <div className="relative flex size-28 shrink-0 items-center justify-center">
                  <svg className="absolute inset-0 size-full" viewBox="0 0 88 88" fill="none">
                    ...
                    <path
                      ...
                      stroke={i === 0 || i === 3 ? "#8D8C8F" : "#084E75"}
                      strokeWidth="1.5" strokeLinecap="round"
                      opacity={i === 0 || i === 3 ? "0.9" : "0.35"}
                    />
                    {/* Gold accent dot at 9 o'clock */}
                    <circle cx="4" cy="44" r="3.5" fill="#8D8C8F" />
                  </svg>
                ...
                <div className="hidden sm:block h-28 w-px shrink-0 bg-linear-to-b from-[#8D8C8F]/70 via-[#8D8C8F]/30 to-transparent" />

                {/* Content */}
                <div className="flex-1 pt-1 text-center sm:text-left">
                  <span className="text-xs font-bold tracking-[0.2em] text-[#8D8C8F]">
                    {String(i + 1).padStart(2, "0")}
                  </span>
                  <h6 className="mt-1 text-lg font-bold leading-snug text-[#084E75]">
                    {belief.title}
                  </h6>
                  <div className="mb-3 mt-2 mx-auto h-px w-8 bg-[#8D8C8F] sm:mx-0" />
