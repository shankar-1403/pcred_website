        ...
        <div className="relative mx-auto max-w-7xl px-6">
          ...
          >
            ...
            <h1 className="font-serif mt-1 text-3xl font-bold text-white md:text-4xl lg:text-5xl leading-tight">
              ...
              <span className="bg-linear-to-r from-[#00b2fc] to-[#0037d8] bg-clip-text text-transparent">Businesses at Critical Stages of Growth.</span>
            </h1>
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
            ...
            >
              ...
              <h2 className="font-serif text-3xl font-bold leading-snug text-[#00255a] md:text-4xl">
                ...
                <br />
                <span className="bg-linear-to-r from-[#00b2fc] to-[#0037d8] bg-clip-text text-transparent">Not Simply Reports.</span>
              </h2>
        ...
        <div className="relative mx-auto max-w-7xl px-6">
          ...
          >
            ...
            <h2 className="font-serif text-3xl font-bold text-white md:text-4xl">
              Financial Leadership <span className="bg-linear-to-r from-[#00b2fc] to-[#0037d8] bg-clip-text text-transparent">Solutions</span>
            </h2>
          ...
          >
            <div>
              ...
              <h2 className="font-serif mt-4 text-3xl font-bold text-[#00255a] md:text-4xl leading-tight">
                Clarity First.<br/>
                <span className="bg-linear-to-r from-[#00b2fc] to-[#0037d8] bg-clip-text text-transparent">Decisions Second.</span>
              </h2>
            ...
            <div className="relative w-full items-center justify-center overflow-hidden rounded-3xl">
              <Image
                src={analyticsImage}
            ...
            <div className="relative flex flex-col items-center text-center justify-between gap-8 md:flex-row md:items-center md:text-left">
              <div className="max-w-xl">
                ...
                <h2 className="font-serif text-3xl font-semibold text-white md:text-4xl md:leading-tight">
                  Need Financial
                  <br />
                  <span className="bg-linear-to-r from-[#00b2fc] to-[#0037d8] bg-clip-text text-transparent">Leadership?</span>
                </h2>
