        ...
        <div className="relative mx-auto max-w-7xl px-6">
          ...
          >
            ...
            <h1 className="font-serif mt-1 text-3xl font-bold text-white md:text-4xl lg:text-5xl leading-tight">
              ...
              <span className="bg-linear-to-r from-[#D9B872] to-[#96701F] bg-clip-text text-transparent">Strategy.</span>
            </h1>
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
            ...
            >
              ...
              <h2 className="font-serif text-3xl font-bold leading-snug text-[#084E75] md:text-4xl">
                ...
                <br />
                <span className="bg-linear-to-r from-[#D9B872] to-[#96701F] bg-clip-text text-transparent">Not the Deal.</span>
              </h2>
        ...
        <div className="relative mx-auto max-w-7xl px-6">
          ...
          >
            ...
            <h2 className="font-serif text-3xl font-bold text-white md:text-4xl">
              Transaction <span className="bg-linear-to-r from-[#D9B872] to-[#96701F] bg-clip-text text-transparent">Advisory</span>
            </h2>
            ...
            <div className="relative flex flex-col items-start justify-between gap-8 md:flex-row md:items-center">
              <div className="max-w-xl">
                ...
                <h2 className="font-serif text-3xl font-semibold text-white md:text-4xl md:leading-tight">
                  Considering a
                  <br />
                  <span className="bg-linear-to-r from-[#D9B872] to-[#96701F] bg-clip-text text-transparent">Transaction?</span>
                </h2>
