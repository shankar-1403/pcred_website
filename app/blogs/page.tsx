    ...
    >
      <div className="relative aspect-video overflow-hidden bg-[#084E75]/5">
        {blog.cover_image ? (
          ...
          <div className="h-full w-full bg-linear-to-br from-[#084E75]/10 to-[#8D8C8F]/10" />
        )}
      ...
      <div className="flex flex-1 flex-col p-6">
        ...
        <Link
          href={`/blogs/${blog.id}`}
          className="inline-flex w-fit items-center gap-1.5 border-b-2 border-[#084E75] pb-1 text-xs font-semibold uppercase tracking-wider text-[#084E75] transition-colors hover:border-[#8D8C8F] hover:text-[#0a5d8a]"
        >
          Read article
            ...
            <>
              ...
              {currentPage === 1 && featuredBlog && (
                <>
                  ...
                  >
                    <h2 className="font-serif text-2xl font-semibold text-[#084E75] md:text-3xl">Featured Article</h2>
                  </motion.div>
                  ...
                  >
                    ...
                    <div className="relative flex flex-col justify-center p-8 md:col-span-2 md:p-12">
                      ...
                      <Link
                        ...
                        className="group/btn inline-flex w-fit items-center gap-2 border-b-2 border-[#084E75] pb-1 text-sm font-semibold uppercase tracking-wider text-[#084E75] transition-colors hover:border-[#8D8C8F] hover:text-[#0a5d8a]"
                      >
                        Read article
                ...
                <>
                  <div ref={articlesRef}>
                    <motion.div
                      ...
                      className="mb-10"
                    >
                      <h2 className="font-serif text-2xl font-semibold text-[#084E75] md:text-3xl">Latest Articles</h2>
                    </motion.div>
                  </div>
