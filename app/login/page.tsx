      ...
      <div className="w-full max-w-md rounded-2xl border border-slate-800 bg-slate-900/90 p-8 shadow-2xl shadow-black/40">
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-4">
          ...
          <div>
            ...
            <div className="relative mt-1">
              ...
              <button
                ...
                className="absolute right-2 top-1/2 -translate-y-1/2 rounded-full border border-[#00b2fc] p-1 cursor-pointer text-xs text-[#00b2fc] hover:bg-slate-800"
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full cursor-pointer rounded-lg bg-[#00255a] py-2.5 text-sm font-semibold text-neutral-100 transition hover:bg-[#0037d8] disabled:opacity-50"
          >
